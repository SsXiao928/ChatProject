...
ChatDialog::ChatDialog(QWidget *parent)
    : QDialog(parent),_mode(ChatUIMode::ChatMode),
    ...
    , ui(new Ui::ChatDialog)
{
    ...
    ui->search_edit->addAction(searchAction,QLineEdit::LeadingPosition);//QLineEdit::LeadingPosition头部位置
...
void ChatDialog::addChatUserList()
{
    ...
    for(int i = 0; i < 13; i++){
        ...
        //qDebug() << chat_user_wid->styleSheet();
        //chat_user_wid->show();
...
bool ChatDialog::eventFilter(QObject *watched, QEvent *event)
{
    ...
    return QDialog::eventFilter(watched, event);//调用基类的基本功能
}
...
void ChatDialog::handleGlobalMousePress(QMouseEvent *event)
{
    ...
    //mapFromGlobal从全局位置转为search_list中的位置
